...
public class UpdateActivityTuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_tuesday);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataBaseTuesday myDB = new DataBaseTuesday(UpdateActivityTuesday.this);
