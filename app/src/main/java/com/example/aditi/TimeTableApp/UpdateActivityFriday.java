...
public class UpdateActivityFriday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_friday);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataBaseFriday myDB = new DataBaseFriday(UpdateActivityFriday.this);
