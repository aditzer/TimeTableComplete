...
public class UpdateActivitySunday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_sunday);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataBaseSunday myDB = new DataBaseSunday(UpdateActivitySunday.this);
