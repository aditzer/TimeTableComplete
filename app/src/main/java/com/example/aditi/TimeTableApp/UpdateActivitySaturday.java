...
public class UpdateActivitySaturday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_saturday);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataBaseSaturday myDB = new DataBaseSaturday(UpdateActivitySaturday.this);
