...
class DataBaseSaturday extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "Saturday.db";
    ...
    DataBaseSaturday(@Nullable Context context) {
    ...
    void deleteAllData(Context context){
        context.deleteDatabase("Saturday.db");
    }
