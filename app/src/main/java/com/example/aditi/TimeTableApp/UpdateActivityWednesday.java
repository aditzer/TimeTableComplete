...
public class UpdateActivityWednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_wednesday);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DataBaseWednesday myDB = new DataBaseWednesday(UpdateActivityWednesday.this);
