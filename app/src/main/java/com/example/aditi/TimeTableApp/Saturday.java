...
public class Saturday extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    DataBaseSaturday myDB;
    ArrayList<String> Lec_id, sub, books;
    CustomAdapterSaturday customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Saturday.this, AddActivitySaturday.class);
                startActivity(intent);
            }
        });

        myDB = new DataBaseSaturday(Saturday.this);
        ...
        customAdapter = new CustomAdapterSaturday(Saturday.this,this, Lec_id, sub, books);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Saturday.this));
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                DataBaseSaturday myDB = new DataBaseSaturday(Saturday.this);
                myDB.deleteAllData(Saturday.this);
                //Refresh Activity
    ...
    public void onClickSaturdayReminder(View v){
        DialogFragment timePickerDialog =new TimePickerFragment();
        timePickerDialog.show(getSupportFragmentManager(),"time picker6");
    }
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        Intent intent = new Intent(getApplicationContext(), SaturdayReminder.class);
